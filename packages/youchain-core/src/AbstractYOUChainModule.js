...
import {HttpProvider, WebsocketProvider, IpcProvider} from 'youchain-providers';
import {toChecksumAddress} from 'youchain-utils';

export default class AbstractYOUChainModule {
    /**
     ...
     */
    constructor(
        provider = AbstractYOUChainModule.throwIfMissing('provider'),
        providersModuleFactory = AbstractYOUChainModule.throwIfMissing('ProvidersModuleFactory'),
    ...
    /**
     * Returns a object with factory methods for the YOUChain providers.
     *
     * @property providers
     *
     * @returns {Object}
     ...
     * TODO: AbstractYOUChainModule (factory.createAddress())
     *
