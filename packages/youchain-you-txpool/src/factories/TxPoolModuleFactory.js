...
export default class TxPoolModuleFactory {
    /**
     * @param {Utils} utils
    ...
    /**
     * Returns an object of type TxPool
     *
     * @method createTxPool
     *
     ...
     * @returns {TxPool}
     */
    createTxPoolModule(provider, providersModuleFactory, methodModuleFactory, net, options) {
        return new TxPool(
            provider,
