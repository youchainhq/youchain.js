...
export default class AbstractSocketProvider extends EventEmitter {
     ...
     */
    subscribe(subscribeMethod = 'you_subscribe', subscriptionMethod, parameters) {
     ...
     */
    unsubscribe(subscriptionId, unsubscribeMethod = 'you_unsubscribe') {
     ...
     * @returns {Promise<Boolean|Error>}
     */
    clearSubscriptions(unsubscribeMethod = 'you_unsubscribe') {
