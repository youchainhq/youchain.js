...
export default class YOU extends AbstractYOUChainModule {
    /**
    ...
    constructor(
        ...
        /**
         * This wrapper function is required for the "new youchain.you.Contract(...)" call.
         *
         * @param {Object} abi
     ...
     */
    clearSubscriptions() {
        return super.clearSubscriptions('you_unsubscribe');
    }
     ...
     * This is required for updating the provider also in the sub packages and objects related to You.
     *
