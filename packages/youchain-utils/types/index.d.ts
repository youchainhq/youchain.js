...
export function fromLu(value: string | BN, unit?: Unit): string;
...
export function toLu(val: BN, unit?: Unit): BN;
export function toLu(val: string, unit?: Unit): string;
...
export interface Utils {
    ...
    fromLu(value: string | BN, unit?: Unit): string;
    ...
    toLu(val: BN, unit?: Unit): BN;
    toLu(val: string, unit?: Unit): string;
