...
describe('UtilsTest', () => {
    ...
    it('calls fromLu and returns the expected results', () => {
        expect(fromLu('1000000000000000000', 'lu')).toEqual('1000000000000000000');

        expect(fromLu('1000000000000000000', 'klu')).toEqual('1000000000000000');

        expect(fromLu('1000000000000000000', 'mlu')).toEqual('1000000000000');

        expect(fromLu('1000000000000000000', 'glu')).toEqual('1000000000');

        expect(fromLu('1000000000000000000', 'micro')).toEqual('1000000');

        expect(fromLu('1000000000000000000', 'milli')).toEqual('1000');

        expect(fromLu('1000000000000000000', 'you')).toEqual('1');

        expect(fromLu('1000000000000000000', 'kyou')).toEqual('0.001');

        expect(fromLu('1000000000000000000', 'myou')).toEqual('0.000001');

        expect(fromLu('1000000000000000000', 'gyou')).toEqual('0.000000001');

        expect(fromLu('1000000000000000000', 'tyou')).toEqual('0.000000000001');
    });
    ...
    it('calls toLu and returns the expected results', () => {
        expect(toLu('1', 'lu')).toEqual('1');

        expect(toLu('1', 'klu')).toEqual('1000');

        expect(toLu('1', 'Klu')).toEqual('1000');

        expect(toLu('1', 'mlu')).toEqual('1000000');

        expect(toLu('1', 'Mlu')).toEqual('1000000');

        expect(toLu('1', 'glu')).toEqual('1000000000');

        expect(toLu('1', 'Glu')).toEqual('1000000000');

        expect(toLu('1', 'you')).toEqual('1000000000000000000');

        expect(toLu('1', 'kyou')).toEqual('1000000000000000000000');

        expect(toLu('1', 'myou')).toEqual('1000000000000000000000000');

        expect(toLu('1', 'gyou')).toEqual('1000000000000000000000000000');

        expect(toLu('1', 'tyou')).toEqual('1000000000000000000000000000000');

        expect(toLu('1', 'milli')).toEqual(toLu('1000', 'micro'));
