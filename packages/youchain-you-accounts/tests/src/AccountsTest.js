...
import {GetGasPriceMethod, GetTransactionCountMethod, MethodModuleFactory, VersionMethod} from 'youchain-core-method';
...
describe('AccountsTest', () => {
    ...
    it('constructor check', () => {
        ...
        expect(accounts.wallet.defaultKeyName).toEqual('youchainjs_wallet');

        expect(accounts).toBeInstanceOf(AbstractYOUChainModule);
    });
    ...
    it('calls signTransaction without networkId, gasPrice, nonce and returns a resolved promise', async () => {
        const callback = jest.fn();
    ...
    it('calls singTransaction and returns a rejected promise because it could not fetch the missing properties', async () => {
        ...
        await expect(accounts.signTransaction({}, 'pk', () => {})).rejects.toThrow(
            `One of the values 'networkId', 'gasPrice', or 'nonce' couldn't be fetched: ${JSON.stringify([
                null,
                null,
                null
            ])}`
    ...
    it('calls singTransaction and returns a rejected promise because of invalid values in the TX', async () => {
        ...
        await expect(accounts.signTransaction(tx, 'pk', () => {})).rejects.toThrow(
            'Gas, gasPrice, nonce or networkId is lower than 0'
        );
    });
